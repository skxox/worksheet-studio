...
const modules = [
  {
    id: 'copybook',
    title: '字帖工坊',
    description: '汉字、词组、段落、笔画、拼音、英文、数字、控笔，多类型字帖一键生成。',
    icon: Pen,
    href: '/copybook',
  ...
  },
  {
    id: 'handwriting',
    title: '手写模拟器',
    description: '文本转手写体，支持涂改、位置/笔画/字形凌乱度调节，真实纸张质感。',
    icon: FileText,
    href: '/handwriting',
  ...
  },
  {
    id: 'paper',
    title: '纸张工厂',
    description: '方格、横线、点阵、康奈尔、五线谱、田字格、米字格、回宫格，导出 PDF/PNG/SVG。',
    icon: Grid3x3,
    href: '/paper',
    ...
    <main className="flex flex-1 flex-col">
      ...
      <section className="border-b bg-linear-to-b from-muted/50 to-background">
        <div className="mx-auto max-w-6xl px-4 py-20 text-center">
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">好字是练出来的</h1>
          ...
          {modules.map((m) => {
            ...
            return (
              <Link key={m.id} href={m.href} className="group">
                <Card className="h-full cursor-pointer border-0 bg-muted/40 shadow-sm transition-all hover:-translate-y-1 hover:shadow-lg">
                  <CardHeader>
                    <div
                    ...
                    <CardTitle className="flex items-center text-xl">{m.title}</CardTitle>
